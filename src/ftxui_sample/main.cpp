...
// configuration step. It creates a namespace called `GAP`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", GAP::cmake::project_name, GAP::cmake::project_version) };
