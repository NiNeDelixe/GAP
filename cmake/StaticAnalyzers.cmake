...
macro(GAP_tool_not_found_warning TOOL_NAME)
  message(${GAP_WARNING_TYPE} "${TOOL_NAME} was requested but executable was not found. Please install ${TOOL_NAME} to enable this feature.")
endmacro()

macro(GAP_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    GAP_tool_not_found_warning("cppcheck")
  endif()
endmacro()

macro(GAP_enable_clang_tidy target WARNINGS_AS_ERRORS)
  ...
  if(CLANGTIDY)
    ...
    GAP_tool_not_found_warning("clang-tidy")
  endif()
endmacro()

macro(GAP_enable_include_what_you_use)
  find_program(INCLUDE_WHAT_YOU_USE include-what-you-use)
  if(INCLUDE_WHAT_YOU_USE)
    set(CMAKE_CXX_INCLUDE_WHAT_YOU_USE ${INCLUDE_WHAT_YOU_USE})
  else()
    GAP_tool_not_found_warning("include-what-you-use")
  endif()
endmacro()

macro(GAP_enable_lizard WARNINGS_AS_ERRORS)
  find_program(LIZARD lizard)
  if(LIZARD)
    include(cmake/Lizard.cmake)
    # Function defined in Lizard.cmake
    GAP_setup_lizard(${WARNINGS_AS_ERRORS})
  else()
    GAP_tool_not_found_warning("lizard")
  endif()
endmacro()

# Enable Bloaty McBloatface for binary size analysis
macro(GAP_enable_bloaty)
  ...
  if(BLOATY)
    ...
    GAP_tool_not_found_warning("bloaty")
  endif()
endmacro()
