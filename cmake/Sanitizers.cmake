function(
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    if(${ENABLE_SANITIZER_LEAK})
      ...
      if(APPLE)
        message(WARNING "Leak sanitizer is not supported on Apple platforms; ignoring GAP_ENABLE_SANITIZER_LEAK")
      else()
    ...
    if(${ENABLE_SANITIZER_THREAD})
      if("address" IN_LIST SANITIZERS OR "leak" IN_LIST SANITIZERS)
        message(${GAP_WARNING_TYPE} "Thread sanitizer does not work with Address and Leak sanitizer enabled")
      else()
    ...
    if(${ENABLE_SANITIZER_MEMORY} AND CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
      ...
      if("address" IN_LIST SANITIZERS
        ...
        message(${GAP_WARNING_TYPE} "Memory sanitizer does not work with Address, Thread or Leak sanitizer enabled")
      else()
  ...
  elseif(MSVC)
    ...
    if(${ENABLE_SANITIZER_LEAK}
      ...
      message(${GAP_WARNING_TYPE} "MSVC only supports address sanitizer")
    endif()
  endif()
